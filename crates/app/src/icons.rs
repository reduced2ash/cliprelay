...
impl AssetSource for ClipRelayAssets {
    fn load(&self, path: &str) -> Result<Option<Cow<'static, [u8]>>> {
        let bytes: Option<&'static [u8]> = match path {
            ...
            "icons/info.svg" => Some(icon_svg!(r#"<circle cx="12" cy="12" r="9"/><path d="M12 11v5"/><path d="M12 8h.01"/>"#)),
            "icons/maximize.svg" => Some(icon_svg!(r#"<path d="M8 3H3v5"/><path d="m3 3 6 6"/><path d="M16 3h5v5"/><path d="m21 3-6 6"/><path d="M8 21H3v-5"/><path d="m3 21 6-6"/><path d="M16 21h5v-5"/><path d="m21 21-6-6"/>"#)),
            "icons/mark-in.svg" => Some(icon_svg!(r#"<path d="M6 4v16"/><path d="m18 7-5 5 5 5"/>"#)),
            "icons/mark-out.svg" => Some(icon_svg!(r#"<path d="M18 4v16"/><path d="m6 7 5 5-5 5"/>"#)),
            "icons/panel-left.svg" => Some(icon_svg!(r#"<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 4v16"/>"#)),
            "icons/pause.svg" => Some(icon_svg!(r#"<path d="M8 5v14"/><path d="M16 5v14"/>"#)),
            "icons/pencil.svg" => Some(icon_svg!(r#"<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L8 18l-4 1 1-4z"/>"#)),
            "icons/play.svg" => Some(icon_svg!(r#"<path d="m8 5 11 7-11 7z"/>"#)),
            "icons/plus.svg" => Some(icon_svg!(r#"<path d="M12 5v14"/><path d="M5 12h14"/>"#)),
            "icons/refresh.svg" => Some(icon_svg!(r#"<path d="M20 11a8 8 0 1 0-2.3 5.7"/><path d="M20 4v7h-7"/>"#)),
            "icons/search.svg" => Some(icon_svg!(r#"<circle cx="11" cy="11" r="7"/><path d="m20 20-4-4"/>"#)),
            "icons/send.svg" => Some(icon_svg!(r#"<path d="m22 2-7 20-4-9-9-4z"/><path d="M22 2 11 13"/>"#)),
            "icons/settings.svg" => Some(icon_svg!(r#"<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-2.8 2.8-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6v.2h-4V21a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1L4.2 17l.1-.1a1.7 1.7 0 0 0 .3-1.9A1.7 1.7 0 0 0 3 14H2.8v-4H3a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9L4.2 7 7 4.2l.1.1A1.7 1.7 0 0 0 9 4.6 1.7 1.7 0 0 0 10 3V2.8h4V3a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1L19.8 7l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1h.2v4H21a1.7 1.7 0 0 0-1.6 1Z"/>"#)),
            "icons/shuffle.svg" => Some(icon_svg!(r#"<path d="M3 7h3c4 0 5 10 9 10h6"/><path d="m18 14 3 3-3 3"/><path d="M3 17h3c4 0 5-10 9-10h6"/><path d="m18 4 3 3-3 3"/>"#)),
            "icons/skip-back.svg" => Some(icon_svg!(r#"<path d="M19 20 9 12l10-8z"/><path d="M5 19V5"/>"#)),
            "icons/skip-forward.svg" => Some(icon_svg!(r#"<path d="m5 4 10 8-10 8z"/><path d="M19 5v14"/>"#)),
            "icons/square.svg" => Some(icon_svg!(r#"<rect x="5" y="5" width="14" height="14" rx="2"/>"#)),
            "icons/target.svg" => Some(icon_svg!(r#"<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v3"/><path d="M12 19v3"/><path d="M2 12h3"/><path d="M19 12h3"/>"#)),
            "icons/terminal.svg" => Some(icon_svg!(r#"<path d="m5 7 5 5-5 5"/><path d="M13 17h6"/>"#)),
            "icons/trash.svg" => Some(icon_svg!(r#"<path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="m19 6-1 15H6L5 6"/><path d="M10 11v5"/><path d="M14 11v5"/>"#)),
            "icons/warning.svg" => Some(icon_svg!(r#"<path d="m12 3 10 18H2z"/><path d="M12 9v5"/><path d="M12 17h.01"/>"#)),
            "icons/x.svg" => Some(icon_svg!(r#"<path d="m6 6 12 12"/><path d="m18 6-12 12"/>"#)),
            _ => None,
        };
