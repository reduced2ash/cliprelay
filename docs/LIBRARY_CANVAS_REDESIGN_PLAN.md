...
work adds no loading copy or progress chrome to the media well. Failures retain
a warning glyph, and aggregate state remains visible in the library footer.
