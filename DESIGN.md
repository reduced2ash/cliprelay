...
The visual system rejects generic corporate dashboards, neon editing suites, oversized SaaS cards, glassmorphism, and miniature nonlinear-editor complexity. The reference composition is stored at `docs/design/cliprelay-north-star.png`; it is a hierarchy and density contract, not a raster asset used in the product.
